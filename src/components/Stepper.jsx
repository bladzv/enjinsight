  ...
  return (
    <div className="flex items-center justify-center gap-2.5">
      ...
      <input
        ...
        className={`step-val tabular border-none bg-transparent px-0 py-0 text-center font-mono font-bold tracking-tight text-primary focus:outline-hidden disabled:opacity-50
